...
# Importe für Sicherheits-Angelegenheiten
...
CLIENT_ID = json.loads(
    open('client_secrets.json', 'r').read())['web']['client_id'] #!#!vorher bei GoogleAPI Developer das zum Programm gehörige JSON herunterladen und im gleichen Ordner speichern, wie diese Datei hier
...
def gconnect():
    ...
    try:
        ...
        #raise###
        print ('Authorization code holen schief gegangen')###
        response = make_response(
            json.dumps('Failed to upgrade the authorization code.'), 401)
        response.headers['Content-Type'] = 'application/json'
        return response

    print ('Überprüfe Access Token')###
